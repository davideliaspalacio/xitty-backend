...
export class FeaturedResponseDto {
  ...
  @ApiProperty({ nullable: true }) custom_title: string | null;
  @ApiProperty({ nullable: true }) custom_description: string | null;
  ...
  @ApiProperty({ nullable: true, type: FeaturedPlaceDto })
  place: FeaturedPlaceDto | null;
}

export class FeaturedListResponseDto {
  @ApiProperty({ type: [FeaturedResponseDto] }) data: FeaturedResponseDto[];
