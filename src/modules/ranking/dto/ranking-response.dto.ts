...
export class RankingItemDto {
  ...
  @ApiProperty({ nullable: true, description: 'Positive = climbed, negative = dropped, 0 = same' })
  position_change: number | null;
  @ApiProperty() score: number;
  @ApiProperty() views_30d: number;
  @ApiProperty() conversions_30d: number;
  @ApiProperty() is_sponsored: boolean;
  @ApiProperty({ nullable: true, description: 'Display label when item is sponsored' })
