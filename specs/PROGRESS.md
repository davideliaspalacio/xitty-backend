...
- 2026-07-09: PR tecnico preparado: `chore/backend-lint-notification-settings-controller`; notification settings controller queda tipado y con lint dirigido limpio.
...
- Backend full lint: `npx eslint "src/**/*.ts"` -> falla por deuda historica restante documentada en `specs/LINT_DEBT.md`; baja a 52 archivos / 163 errores / 28 warnings.
